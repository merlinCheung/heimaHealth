...
import com.itheima.commin.MessageConstant;
...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "LxKwB_DcIpahWULYLrIhDddOv_qVcNDR68fJ_5PG";
    private static final String SECRETKEY = "sgNn353sKV8Y-TqwY1aelE9pQ9OjBtMa9vjbmpSt";
    private static final String BUCKET = "zhangyongmin";
    public static final String DOMAIN= "http://puy2ehjxo.bkt.clouddn.com";
